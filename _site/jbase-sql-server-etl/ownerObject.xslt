...
<xsl:stylesheet version="1.0"
  ...
  <!-- When we see a <ownerObject> element... -->
  <xsl:template match="ownerObject">
    <h2 style="margin-top:0px;margin-bottom:1px;">
  ...
  <xsl:template match="usage">
    <table style="width:625px;margin-bottom:5px;" cellspacing="5" cellpadding="5">
      <tr><th style="text-align:left;">Usage</th></tr>
      <xsl:choose>
